<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CollDetail_Show_Position.aspx.vb" Inherits="CollDetail_Show_Position" %>
    ...
    <script type="text/javascript">
        ...
        if (GBrowserIsCompatible()) {
            ...
            function loadMark() {
                ...
                var file = "Price3DB.aspx?action=8&Req_Id=" + reqid + "&Hub_Id=" + hubid;
                GDownloadUrl(file, function(doc) {
                    ...
                    if ((markers.length) > 0) {
                        for (var i = 0; i < markers.length; i++) {
                            ...
                            map.setCenter(new GLatLng(nlat, nlng), 15);
