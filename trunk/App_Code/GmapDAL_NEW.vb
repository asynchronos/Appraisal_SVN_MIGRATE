...
Public Class GmapDAL_NEW
    ...
    Public Function getGmapBy_Price3_Req_ID(ByVal Req_Id As Integer, ByVal Temp_AID As Integer) As List(Of Price3_Master)
        ...
        Try
            ...
            Dim sql As String = "SELECT " _
                ...
                & " isnull(Create_Date,getdate()) as Create_Date " _
             & "FROM Price3_Master " _
             & "WHERE Req_Id=@Req_Id AND Temp_AID =@Temp_AID " _
             & "ORDER BY Req_Id"
            ...
            sqlCmd.Parameters.AddWithValue("@Req_Id", Req_Id)
            sqlCmd.Parameters.AddWithValue("@Temp_AID", Temp_AID)
    ...
    Public Sub updatePrice3Master(ByVal objPrice3Master As Price3_Master)
        ...
        Try
            ...
            sqlCmd.Parameters.AddWithValue("@Req_Id", objPrice3Master.Req_Id)
    ...
    Public Function binding_Gmap_Price3(ByVal reader As SqlDataReader) As Price3_Master
