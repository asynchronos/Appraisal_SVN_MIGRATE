...
<body style="margin-top: 0px; margin-left: 0px; margin-right: 0px;">
    ...
    <ajaxToolkit:TabContainer runat="server" ID="tabContainerRegister" Height="1000px"
        ...
        <ajaxToolkit:TabPanel runat="server" ID="talPanelAdditional" HeaderText="รายละเอียดสิ่งปลูกสร้าง"><ContentTemplate>
            <table style="margin-right: 0px"><tr><td>อาชีพปัจจุบัน: </td><td><asp:TextBox ID="txtOccupation" runat="server"></asp:TextBox></td></tr><tr><td>สิ่งที่คุณสนใจ: </td><td>
                <asp:CheckBoxList ID="cblInterest" runat="server" RepeatColumns="2"><asp:ListItem Text="บันเทิง" Value="1"></asp:ListItem><asp:ListItem Text="การเมือง" Value="2"></asp:ListItem><asp:ListItem Text="กีฬา" Value="3"></asp:ListItem><asp:ListItem Text="วิทยาศาสตร์" Value="4"></asp:ListItem></asp:CheckBoxList></td></tr><tr><td></td><td></td><td><asp:Button ID="btnSave" Text="บันทึก" runat="server" /></td></tr></table></ContentTemplate></ajaxToolkit:TabPanel>
