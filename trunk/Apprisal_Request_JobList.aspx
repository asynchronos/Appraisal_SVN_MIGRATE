...
&nbsp;<asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource_APPLICATION_TYPE" 
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="CollOfNumber" HeaderText="เลขที่หลักประกัน" 
                SortExpression="CollOfNumber" />
            <asp:BoundField DataField="TambonName" HeaderText="ตำบล" 
                SortExpression="TambonName" />
            <asp:BoundField DataField="AmphurName" HeaderText="อำเภอ" 
                SortExpression="AmphurName" />
            <asp:BoundField DataField="ProvinceName" HeaderText="จังหวัด" 
                SortExpression="ProvinceName" />
            <asp:BoundField DataField="Branch_Id" HeaderText="รหัสฝ่ายงาน/สาขา" 
            
                SortExpression="Branch_Id" ReadOnly="True" />
                
            <asp:BoundField DataField="DeptSender" HeaderText="ฝ่ายงาน/สาขา ที่ส่ง" 
            
                SortExpression="DeptSender" ReadOnly="True" />
            <asp:BoundField DataField="Create_Date" HeaderText="วันที่ส่งเรื่อง" 
                SortExpression="Create_Date" />
            <asp:BoundField DataField="Hub_ID" HeaderText="รหัสศูนย์" 
                SortExpression="Hub_ID" ReadOnly="True" />
            <asp:BoundField DataField="HUB_NAME" HeaderText="ศูนย์ประเมิน" 
                SortExpression="HUB_NAME" />
            <asp:BoundField DataField="APP_TYPE_NAME" HeaderText="ประเภทงาน" 
