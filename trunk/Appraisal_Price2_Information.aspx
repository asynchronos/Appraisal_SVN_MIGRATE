<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Price2_Information.aspx.vb"
...
<body>
    ...
    <div>
        ...
        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" Height="352px" Width="100%"
            ActiveTabIndex="0">
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                    BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="sdsPrice2"
                                    GridLines="Horizontal" Height="108px" Width="100%" Style="font-size: small">
                                    <AlternatingRowStyle BackColor="#F7F7F7" />
                                    <Columns>
                                        <asp:BoundField DataField="ID" HeaderText="ลำดับ" SortExpression="ID">
                                            <ItemStyle Width="50px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="CollType_ID" HeaderText="ประเภท" SortExpression="CollType_ID">
                                            <ItemStyle Width="50px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="SubCollType_Name" HeaderText="หลักประกัน" SortExpression="SubCollType_Name" />
                                        <asp:BoundField DataField="Address_No" HeaderText="เลขที่" ReadOnly="True" SortExpression="Address_No" />
                                        <asp:BoundField DataField="Tumbon" HeaderText="ตำบล" ReadOnly="True" SortExpression="Tumbon" />
                                        <asp:BoundField DataField="Amphur" HeaderText="อำเภอ" ReadOnly="True" SortExpression="Amphur" />
                                        <asp:BoundField DataField="PROV_NAME" HeaderText="จังหวัด" SortExpression="PROV_NAME" />
                                    </Columns>
                                ...
                                <asp:SqlDataSource ID="sdsPrice2" runat="server" ConnectionString="<%$ ConnectionStrings:AppraisalConn %>"
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="lblReq_Id" Name="Req_Id" PropertyName="Text" Type="Int32" />
                                        <asp:ControlParameter ControlID="lblHub_Id" Name="Hub_Id" PropertyName="Text" Type="Int32" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </td>
                        </tr>
            ...
            <ajaxToolkit:TabPanel runat="server" ID="talPanelAdditional" HeaderText="ข้อมูลเพิ่มเติมราคาที่ 1">
                <ContentTemplate>
                    <asp:SqlDataSource ID="Appraisal_Request_PicturePath1" runat="server" ConnectionString="<%$ ConnectionStrings:AppraisalConn %>"
                    ...
                    <div>
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            CellPadding="4" DataSourceID="Appraisal_Request_PicturePath1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ไฟล์ที่แนบมากับการให้ราคาที่ 1">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="linkPath0" runat="server" NavigateUrl='<%#  "UploadedFiles/Pic_RegID/" &  EVAL("Picture_Path") %>'
            ...
            <ajaxToolkit:TabPanel runat="server" ID="TabPanel1" HeaderText="ข้อมูลเพิ่มเติมราคาที่ 2">
                <ContentTemplate>
                    <div>
                        ...
                        <asp:GridView ID="GridView4" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            CellPadding="4" DataKeyNames="Req_ID,Hub_ID,Picture_Path" DataSourceID="Appraisal_Request_PicturePath"
                            ForeColor="#333333" GridLines="None" Style="font-size: small">
                            <Columns>
