<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Report_FullForm4Other.aspx.vb" Inherits="Appraisal_Report_FullForm4Other" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function changeShowFillAID() {
            var reqid = document.getElementById('<%=hdfReq_Id.ClientID%>').value;
            var cif = document.getElementById('<%=lblCif.ClientID%>').innerHTML;
            var cifName = document.getElementById('<%=lblCifName.ClientID%>').innerHTML;
            var myId = "IframeShowFillAID";
            var url = "Appraisal_Fill_AID.aspx";
            var param = "Req_Id=" + reqid + "&Cif=" + cif + "&CifName=" + cifName + "&PopupModal=mpeBehaviorShowFillAID";
...
<body style="font-family: Tahoma; font-size: medium;">
    ...
    <div>
                    ...
                    <table>
                        <tr>
                            <td align="right" class="NotshowOnPrint">
                                <asp:Button ID="ButtonFillAID" runat="server" Text="กรอก AID" OnClientClick="changeShowFillAID(); return false;" />
                            </td>
                            ...
                            <td class="NotshowOnPrint">
                                <asp:ImageButton ID="ImageButtonClose" runat="server" Height="25px" ImageUrl="~/Images/cancel1.jpg"
                                    ToolTip="ปิดหน้านี้" Width="25px" OnClientClick="windowClosePage(); return false;" />
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <cc1:ModalPopupExtender ID="ModalPopupExtenderShowFillAID" runat="server" TargetControlID="ButtonFillAID"
            PopupControlID="panelShowFillAID" BackgroundCssClass="modalBackground1" 
            BehaviorID="mpeBehaviorShowFillAID">
        </cc1:ModalPopupExtender>
        <cc1:RoundedCornersExtender ID="RoundedCornersExtenderShowFillAID" runat="server" TargetControlID="pnlInnerPopupShowFillAID"
            BorderColor="black" Radius="4">
        </cc1:RoundedCornersExtender>
        <asp:Panel ID="panelShowFillAID" runat="server" CssClass="outerPopup" Style="display: none;">
            <asp:Panel ID="pnlInnerPopupShowFillAID" runat="server" Width="500px" CssClass="innerPopup">
                <iframe id="IframeShowFillAID" src="" width="500" height="200" frameborder="0" scrolling="no">
                </iframe>
            </asp:Panel>
            <div style="white-space: nowrap; text-align: center;">
                <asp:Button ID="ButtonCloseShowFillAID" runat="server" Text="Close" Width="65px" myId="ButtonCloseShowFillAID" />
            </div>
        </asp:Panel>        
    </div>
    </form>
