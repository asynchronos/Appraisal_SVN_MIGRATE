<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Delete_Condo.aspx.vb" Inherits="Appraisal_Delete_Condo" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function deleteSubCollType(id, subCollType) {
            ...
            var Condo_Id = document.getElementById('<%=HiddenFieldCondo_Id.ClientID%>').value;
...
<body>
    ...
    <asp:HiddenField ID="HiddenFieldCondo_Id" runat="server" />
