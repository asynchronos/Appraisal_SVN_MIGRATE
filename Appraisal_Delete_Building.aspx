<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Delete_Building.aspx.vb"
    Inherits="Appraisal_Delete_Building" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function deleteSubCollType(id, subCollType) {
            ...
            var Building_Id = document.getElementById('<%=HiddenFieldBuilding_Id.ClientID%>').value;
            var SubCollType = document.getElementById('<%=HiddenFieldSubCollType.ClientID%>').value;
            //alert(id);
            //alert(subCollType);
            //alert(_req_Id.value);
            //alert(_hub_Id.value);
            PageMethods.DeleteSubCollType(Req_Id, Hub_Id, Building_Id, SubCollType, this.callback);
...
<body>
    ...
    <asp:HiddenField ID="HiddenFieldBuilding_Id" runat="server" />
