<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Appraisal_Price3_Print_CollType70_New.aspx.vb"
    Inherits="Appraisal_Price3_Print_CollType70_New" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>รายละเอียดสิ่งปลูกสร้าง</title>
...
<body>
                        ...
                        <td class="NotshowOnPrint">
                            ...
                            <td class="NotshowOnPrint">
                                <asp:ImageButton ID="ImageButtonClose" runat="server" Height="25px" ImageUrl="~/Images/cancel1.jpg"
                                    ToolTip="ปิดหน้านี้" Width="25px" OnClientClick="windowCurrentClose(); return false;" />
                            </td>                                             
                    </tr>
                </table>            
            </td>
    ...
    <div>
        <h5 style="text-align: center" class="style8">
            รายละเอียดสิ่งปลูกสร้าง</h5>
    </div>
    <table class="style1" width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="CheckBox1" runat="server" Text="ตึกแถว" Enabled="False" />
                &nbsp;<asp:Label ID="lblFloors1" runat="server"></asp:Label>
                &nbsp;ชั้น
            </td>
            <td>
                <asp:CheckBox ID="CheckBox2" runat="server" Text="ทาวน์เฮ้าส์" Enabled="False" />
                &nbsp;<asp:Label ID="lblFloors0" runat="server"></asp:Label>
                &nbsp;ชั้น
            </td>
            <td>
                <asp:CheckBox ID="CheckBox3" runat="server" Text="บ้านพักอาศัย" Enabled="False" />
                &nbsp;<asp:Label ID="lblFloors" runat="server"></asp:Label>
                &nbsp;ชั้น
            </td>
            <td>
                <asp:CheckBox ID="CheckBox4" runat="server" Text="อื่น ๆ" Enabled="False" />
            </td>
            <td>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ชั้น" SortExpression="Floors">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblFloors2" runat="server" Text='<%# Bind("Floors") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="คอนกรีต" SortExpression="Concrete">
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="chkConcrete" runat="server" Checked='<%# Bind("Concrete") %>'>
                                </asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="ผนังอิฐฉาบปูน" SortExpression="BrickWall">
                            <ItemStyle HorizontalAlign="Center" />
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("BrickWall") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="chkBrickWall" runat="server" Checked='<%# Bind("BrickWall") %>'>
                                </asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ผนังอิฐบล็อค" SortExpression="BlockBrickWall">
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="chkBlockBrickWall" runat="server" Checked='<%# Bind("BlockBrickWall") %>'>
                                </asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ผนังไม้" SortExpression="WoodWall">
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="chkWoodWall" runat="server" Checked='<%# Bind("WoodWall") %>'>
                                </asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="อื่นๆ" SortExpression="OtherWall">
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="chkOtherWall" runat="server" Checked='<%# Bind("OtherWall") %>'>
                                </asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="DdsPrice3_70_Detail" runat="server" ConnectionString="<%$ ConnectionStrings:AppraisalConn %>"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="HiddenField3" Name="Hub_Id" PropertyName="Value"
                            Type="Int32" />
                        <asp:ControlParameter ControlID="HiddenField4" Name="Temp_AID" PropertyName="Value"
                            Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="CheckBox5" runat="server" Text="ตกแต่งพร้อมอยู่" Enabled="False" />
            </td>
            <td>
                <asp:CheckBox ID="CheckBox6" runat="server" Text="ตกแต่งบางส่วน" Enabled="False" />
            </td>
            <td>
    ...
    <br />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label6"
        runat="server" Text="กรณีก่อสร้างแล้วเสร็จ 100 % จะมีมูลค่า"></asp:Label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label
        ID="lblGrandTotal100" runat="server"></asp:Label>
    &nbsp;&nbsp;&nbsp; บาท<br />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รวมราคาสิ่งปลูกสร้าง&nbsp;<asp:Label
        ID="lblItems" runat="server"></asp:Label>
    &nbsp;รายการ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    เป็นเงินทั้งสิ้น&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblGrandTotal0" runat="server"></asp:Label>
    &nbsp;&nbsp;&nbsp; บาท<br />
    <br />
    <br />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:SqlDataSource ID="sdsBuilding_Partake_List" runat="server" ConnectionString="<%$ ConnectionStrings:AppraisalConn %>"
        SelectCommand="GET_PRICE3_70_BUILDING_PARTAKE_ALL" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="HiddenField2" Name="Req_Id" PropertyName="Value"
                Type="Int32" />
            <asp:ControlParameter ControlID="HiddenField3" Name="Hub_Id" PropertyName="Value"
