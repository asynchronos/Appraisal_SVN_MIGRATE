...
Partial Class Appraisal_Land
    ...
    Protected Sub ImageSave_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageSave.Click
        ...
        Else
            ...
            ADD_PRICE2_PRICE3_50(Id, CInt(lblReq_Id.Text), CInt(lblHub_Id.Text), 0, 0, 0, CInt(DDLSubCollType.SelectedValue), txtChanode.Text, String.Empty, txtTumbon.Text, txtAmphur.Text, _
    ...
    Protected Sub imgSearchChanode_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgSearchChanode.Click
        ...
        If Obj_GetP50.Count > 0 Then
            ...
            txtPage.Text = Obj_GetP50.Item(0).Ownership
