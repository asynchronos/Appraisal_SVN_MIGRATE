...
Partial Class Appraisal_Price3_70_Detail_Review
    ...
    Protected Sub ImageSave_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageSave.Click
        If LblDescription.Text = "SAVE" Then  'Save Data
            ...
            If ObjP3_Detail.Count = 0 Then  'ถ้ายังไม่มี
                ADD_PRICE3_70_DETAIL_REVIEW(HiddenField4.Value, HiddenField1.Value, HiddenField2.Value, HiddenField3.Value, txtBuildFloor.Text, txtBuilding_Struc.Text, _
        ...
        Else  'Update data
            UPDATE_PRICE3_70_DETAIL_REVIEW(HiddenField4.Value, HiddenField1.Value, HiddenField2.Value, HiddenField3.Value, txtBuildFloor.Text, txtBuilding_Struc.Text, _
                                chkConcrete.Checked, chkGranite.Checked, chkParquet.Checked, chkCeramic.Checked, chkWood.Checked, ChkOther.Checked, txtOtherFloor.Text, _
                                ChkBrickWall.Checked, CheckBlockbrickWall.Checked, ChkWoodWall.Checked, ChkOtherWall.Checked, txtOtherWall.Text, HiddenField5.Value, Now())
        End If
    End Sub
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Dim Obj_P3_70D As List(Of ClsPrice3_70_Detail) = GET_PRICE3_70_DETAIL_REVIEW(HiddenField4.Value, HiddenField1.Value, HiddenField2.Value, HiddenField3.Value, L1.Text)
