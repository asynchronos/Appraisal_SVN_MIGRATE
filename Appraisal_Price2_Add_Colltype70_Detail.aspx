<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Appraisal_Price2_Add_Colltype70_Detail.aspx.vb" Inherits="Appraisal_Price2_Add_Colltype70_Detail" %>
...
<br />
<br />
<p style="font-weight: 700; color: #3333CC">รายละเอียด พื้น ผนัง หลังคา สิ่งปลูกสร้าง</p>
...
<td>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            AllowPaging="True" PageSize="8" style="font-size: small" Width="712px">
            <Columns>
                ...
                <asp:TemplateField HeaderText="ผนังชนิดอื่นๆ" SortExpression="OtherWall" 
                    Visible="False">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="รายละเอียดอื่น ๆ" 
