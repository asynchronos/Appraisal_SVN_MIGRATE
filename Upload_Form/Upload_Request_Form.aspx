<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Upload_Request_Form.aspx.vb"
    Inherits="Upload_Form_Upload_Request_Form" %>
...
<body>
    ...
    <div id="mainDiv">
        ...
        <asp:Button ID="btnSubmit" runat="server" Text="Upload Now" OnClick="btnSubmit_Click"
            Visible="False" />
        <br />
        ไฟล์ที่จะทำการ Upload ต้องเป็นนามสกุล .gif,.png,.jpeg,.jpg,.bmp และ .tiff เท่านั้น
    </div>
